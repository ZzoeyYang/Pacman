(function(global){
	...
	var movePacman = function(self, oldPostion, newPosition, direction){
		...
		var pacman = document.getElementById(newPosition);
		if (direction == "left") {
			pacman.className = "pacman_left";	
		} else if (direction == 'up') {
			pacman.className = "pacman_up";	
		} else if (direction == 'down') {
			pacman.className = "pacman_down";	
	...
	var calculateScore = function(self, newPosition){
		if(self.map[newPosition] == 0) {
			...
			fruit.play();
		} else if (self.map[newPosition] == 9) {
			self.score += 200;
			var fruit = document.getElementById("fruit");
			fruit.play();
		}
	...
	var Game_Over = function (condition) {
       	// var blackout = document.getElementById("blackout");
        // blackout.textContent = condition;
        ...
        //setTimeout(confirm("try again?"),300);
        //confirm("try again?");
    };
		...
		drawWorld: function() {
			...
			for(var i = 0; i < this.map.length; i ++){
				...
				if(this.map[i] == 1){
					...
					this.world.innerHTML += "<div id = '" + i + "' class='dot' style='top:" + top + "px;left:" + left + "px'></div>";
					...
					this.world.innerHTML += "<div id = '" + i + "' class='cion' style='top:" + top + "px;left:" + left + "px'></div>";
				}
			}
